...
Thus, the words that have emerged in the language may effectively capture socially relevant individual differences in emotions. Because words are the basic building blocks of the abstract personality descriptions that are popular in contemporary personality research[^c09-2] (e.g., Big Five and HEXACO), personality trait constructs may ultimately capture socially relevant variation in emotion systems.
