...
description: "Levels of analysis, Tinbergen's four questions, and Marr's three levels as frameworks for studying personality."
---
...
I could tentatively argue that the evolutionary purpose of pessimism is to prevent individuals from engaging in activities that are unlikely to succeed, which may prevent unnecessary energy expenditure. Or perhaps the purpose of pessimism is to magnify the worst in things so that they can be more easily identified and improved, which may result in things improving over time. Either of these will conjectures[^2] will do for now. What potential purposes can you think of for the trait you are analyzing?
