...
\hangindent=0.5in Buss, D. M., **Durkee, P. K.**, Shackelford, T. K., Schmitt, D. P., & Bowdle, B. (Under review). Human status criteria. *Journal of Personality and Social Psychology*. 

\hangindent=0.5in Crosby, C. L., **Durkee, P. K.**, Meston, C. M., & Buss, D. M. (Invited resubmission). Six dimensions of sexual disgust. *Personality and Individual Differences*.

\hangindent=0.5in Lukaszewski, A. W., Lewis, D. M. G., **Durkee, P. K.**, Sell, A., Sznycer, D., & Buss, D. M. (Under review). An adaptationist framework for personality science. *European Journal of Personality*.
...
\hangindent=0.5in **Durkee, P. K.**, Lukaszewski, A. L., Gurven, M., Smaldino, P. E., von Rueden, C. (in prep). Is sociological complexity inversely associated with personality covariation? A test across 120 countries. 
