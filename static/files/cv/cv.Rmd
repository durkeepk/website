...
^\faUnsorted^ ^=^ *^Joint^ ^First^ ^Authorship^* \newline ^**RR**^ ^=^ *^Registered^ ^Report^* 

<!-- ^\faChevronCircleDown^ ^=^ ^Undergraduate^ ^Mentee^ --><!-- ^\faFileTextO^ ^=^ ^Paper^ ^Link^ --><!-- ^\faBarChart^ ^=^ ^Lead^ ^Statistician^ -->

\textcolor{light-gray}{Peer Reviewed Articles}
<!-- \textcolor{light-gray}{2021} -->

15\. \hangindent=0.5in [**Durkee, P. K.**, Lukaszewski, A. L., Buss, D. M. (2023). Status-impact assessment: Is accuracy linked with status motivations? *Evolutionary Human Sciences*.^\faFileTextO^](https://www.cambridge.org/core/services/aop-cambridge-core/content/view/F16454C7E058347A01F94E64565CBF19/S2513843X23000129a.pdf/status-impact-assessment-is-accuracy-linked-with-status-motivations.pdf)^**RR**^

14\. \hangindent=0.5in [**Durkee, P. K.**, Lukaszewski, A. W., von Rueden, C., Gurven, M., Buss, D. M., Tucker-Drob, E. M. (2022). Niche diversity predicts personality structure across 115 nations. *Psychological Science*.^\faFileTextO^](http://www.pdurkee.com/files/pubs/Durkee_etal_2022_PsychScience.pdf)

13\. \hangindent=0.5in [Manson, J. H., Chua, K. J., Rodriguez, N. N., Barlev, M., **Durkee, P. K.**, Lukaszewski, A. W. (2022). Sex differences in fearful personality traits are mediated by physical strength. *Social Psychological and Personality Science*. ^\faFileTextO^](http://www.pdurkee.com/files/pubs/Mansonetal_2022.pdf)

12\. \hangindent=0.5in [Michaelides, M. P., **Durkee, P. K.** (2021). Self-regulation versus self-discipline in predicting achievement: A replication study with secondary data. *Frontiers in Education*.^\faFileTextO^](http://www.pdurkee.com/files/pubs/Michaelides&Durkee.pdf)^**RR**^
...
10\. \hangindent=0.5in [Crosby, C. L.^\faUnsorted^, **Durkee, P. K.**^\faUnsorted^, Sedlacek, A. G. B., Buss, D. M. (2021). Mate availability and sexual disgust. *Adaptive Human Behavior and Physiology.*^\faFileTextO^](http://www.pdurkee.com/files/pubs/Crosby_et_al-2021-Adaptive_Human_Behavior_and_Physiology.pdf)^**RR**^
...
2\. \hangindent=0.5in [**Durkee, P. K.** (In Press). Emotions and Status Hierarchies. In *The Oxford Handbook of Evolution and the Emotions* (eds. L. Al-Shawaf & T. K. Shackleford). Oxford University Press.^\faFileTextO^](https://osf.io/hukwr)
...
1\. \hangindent=0.5in [**Durkee, P. K.**, (2023, June 16). Measuring a Personality Trait is Harder than I Thought: Simulations Exploring the Interplay between Measurands, Mechanisms, and Measurement in Personality Research. *SSRN*. ^\faFileTextO^](http://dx.doi.org/10.2139/ssrn.4482488)

2\. \hangindent=0.5in [**Durkee, P. K.**, Lukaszewski, A. L., Buss, D. M. (2021, April 20). Status foundations: Further consideration of the role of ‘dominance’ and the relative importance of cost infliction and benefit generation. *PsyArXiv*. ^\faFileTextO^](https://psyarxiv.com/4gvt5/)

<!-- \textcolor{light-gray}{Submitted Manuscripts} -->

<!-- 2\. \hangindent=0.5in Lukaszewski, A. L., **Durkee, P. K.**, Zerbe, J. G., Patton, J. Q. (Submitted). Personality Concepts in Conambo, Ecuador. *Evolution and Human Behavior*. -->

<!-- 1\. \hangindent=0.5in Landers, M.^\faUnsorted^, Sznycer., D.^\faUnsorted^, **Durkee, P. K.** (Submitted). Are Self-Conscious Emotions About the Self? Testing Competing Theories of Shame and Guilt Across Two Disparate Cultures.  -->
...
8\. \hangindent=0.5in **Durkee, P. K.** (June, 2023). *Preferences and Personality*. Talk given to the Institute for Advanced Study in Toulouse, France.
...
Personality Psychology (in-person) \hfill \textcolor{light-gray}{Spring 2023}
