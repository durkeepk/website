...
3\. \hangindent=0.5in **Durkee, P. K.**, Baker, K.^\faChevronCircleDown^, Lukaszewski, A. L., & Buss, D. M. (Stage 1 Registered Report Submitted). Status-impact assessment: Does accuracy covary with status motivations?

2\. \hangindent=0.5in **Durkee, P. K.**, & Buss, D. M. (Submitted). Hierarchy Navigation: A Psychological Network Approach to Individual Differences. 

1\. \hangindent=0.5in Michaelides, M. P., **Durkee, P. K.** (Submitted). Self-regulation versus self-discipline in predicting achievement: A replication study with secondary data.
