...
\hangindent=0.5in **Durkee, P. K.**, Lukaszewski, A. L., Buss, D. M. (forthcoming). Pride and shame: Key components of a culturally universal status management system. *Evolution and Human Behavior*.

\hangindent=0.5in [**Durkee, P. K.** (2019). Do the Maasai perceive weak walkers to be stronger and more attractive than strong walkers? A re-analysis of Fink et al. (2019). *Biology Letters, 15*(7).]("files/pubs/Durkee_2019.pdf")
