...
2\. \hangindent=0.5in **Durkee, P. K.**, Lukaszewski, A. L., & Buss, D. M. (Stage 1 Registered Report Submitted). Status-impact assessment: Does accuracy covary with status motivations?
...
8\. \hangindent=0.5in **Durkee, P. K.**, Hahnel-Peeters, R. K., & Buss, D. M. (in prep). Sex differences in physical strength predict those in Emotionality across countries.
