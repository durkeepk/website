...
\hangindent=0.5in **Durkee, P. K.**, Lukaszewski, A. L., & Buss, D. M. (Under editorial review). Psychological foundations of human status allocation. *Proceedings of the National Academy of Sciences*.

\textcolor{light-gray}{Manuscripts in Preparation}


\hangindent=0.5in **Durkee, P. K.**, & Ayers, J. D. (in prep). Is facial width-to-height ratio reliably associated with social inferences? A large cross-national examination. 
