...
Ph.D., Psychology, The University of Texas at Austin \hfill \textcolor{light-gray}{Exp. 2021}
...
Adjunct Professor, Department of Psychology, Texas State University \hfill \textcolor{light-gray}{2021 - Present}
...
12\. \hangindent=0.5in [**Durkee, P. K.**, Lukaszewski, A. W., von Rueden, C., Gurven, M., Buss, D. M., & Tucker-Drob, E. M. (Accepted). Niche diversity predicts personality structure across 115 nations. *Psychological Science*.^\faFileTextO^](https://psyarxiv.com/93qmp/)

11\. \hangindent=0.5in [**Durkee, P. K.**, & Ayers, J. D. (In press). Is facial width-to-height ratio reliably associated with social inferences? *Evolution and Human Behavior*.^\faFileTextO^](http://www.pdurkee.com/files/pubs/Durkee&Ayers2021_fWHR_EHB.pdf)
...
1\. \hangindent=0.5in [**Durkee, P. K.** (Forthcoming). Emotions and Status Hierarchies. In *The Oxford Handbook of Evolution and the Emotions* (eds. L. Al-Shawaf & T. K. Shackleford). Oxford University Press.^\faFileTextO^](https://osf.io/hukwr)
...
3\. \hangindent=0.5in **Durkee, P. K.**, Baker, K.^\faChevronCircleDown^, Lukaszewski, A. L., & Buss, D. M. Status-impact assessment: Does accuracy covary with status motivations? [Stage 1 Registered Report]

2\. \hangindent=0.5in **Durkee, P. K.**, & Buss, D. M. Hierarchy Navigation: A Psychological Network Approach to Individual Differences. 

1\. \hangindent=0.5in Michaelides, M. P., **Durkee, P. K.** (Under Review). Self-regulation versus self-discipline in predicting achievement: A replication study with secondary data.

<!-- \textcolor{light-gray}{Manuscripts in Preparation} -->

<!-- \hangindent=0.5in **Durkee, P. K.**, Baker, K., Buss, D. M. (in prep). Higher status-motivations are associated with greater accuracy in assessing status impacts of personal characteristics.  -->

<!-- \hangindent=0.5in **Durkee, P. K.**, & Buss, D. M. (in prep). Status conferral emotion networks. -->
...
<!-- \hangindent=0.5in Sznycer., D., Patrick., C., **Durkee, P. K.**, & cross-cultural collaborators (in prep). The origins of criminal law: A cross-national investigation. -->

<!-- \hangindent=0.5in **Durkee, P. K.**, Lukaszewski, A. W., von Rueden, C., Gurven, M., Gosling, S., Schulz, J., Henrich, J. (in prep). The cultural evolution of WEIRD personality structure.  -->
