...
date: 2020-01-05 #"`r noquote(format(Sys.Date(), '%Y-%m-%d'))`"
categories: ["R"]
tags: ["R"]
markdown: GFM
---
...
So those are some of my favourite R-esources. I hope this short list could be useful to someone at some point. 
